            ...
            <View style={{ flex: 1, alignItems: "center" }}>
               ...
               >
                  <Image
                     source={{
                        uri:
                           "https://cdn.pixabay.com/photo/2015/05/15/14/55/cafe-768771_1280.jpg"
                     }}
                     style={styles.image}
                  />
                  <View>
                  ...
                  <View style={{ flex: 1 }}>
                     ...
                     <Text style={{ margin: 20, maxWidth: 300, fontSize: 18 }}>
                        Water prices are applied to the store is:{" "}
                        <Text
                           style={{
                              color: "rgba(175,175,175,1.2)",
                              fontStyle: "italic"
                           }}
                        >
                           19000 VND/m3
                  ...
                  <View style={{ flex: 1 }}>
                     ...
                     >
                        The shop applies electricity prices according to the
                        state regulations
                     </Text>
